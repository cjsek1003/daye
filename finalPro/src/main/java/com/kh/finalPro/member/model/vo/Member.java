package com.kh.finalPro.member.model.vo;
...
public class Member implements java.io.Serializable {
	...
	public Member(String member_id, String member_pwd, String member_name, String pwd_hint, String pwd_answer,
			Date member_birth, char gender, String phone, String email, String address) {
		super();
	...
	public String toString() {
		return "member_id=" + member_id + ", member_pwd=" + member_pwd + ", member_name=" + member_name
				+ ", pwd_hint=" + pwd_hint + ", pwd_answer=" + pwd_answer + ", member_birth=" + member_birth
